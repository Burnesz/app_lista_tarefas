	...
	<head>
		...
		<script>
			function editar(id){
				...
				let conteudo = document.getElementById('tarefa_'+id).innerHTML.split(" (")
				let status = conteudo[1].slice(0,-1)
				let tarefa = conteudo[0]
				
				let statusModal = document.getElementById('statusModal')
				statusModal.innerHTML = status
				...
				<form method="post" action="tarefa_controller.php?acao=atualizar">
					...
					<div class="modal-body">
						<dl class="row">
							...
							<dd id ="statusModal" class="col-sm-9"></dd>
